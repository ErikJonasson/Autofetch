...
public abstract class BaseEntityManagerFunctionalTestCase extends BaseUnitTestCase {
	...
	private List<EntityManager> isolatedEms = new ArrayList<>();
	...
	protected Map getConfig() {
		...
		List<Class> classes = new ArrayList<Class>( Arrays.asList( getAnnotatedClasses() ) );
		...
		if ( getEjb3DD().length > 0 ) {
			ArrayList<String> dds = new ArrayList<>( Arrays.asList( getEjb3DD() ) );
